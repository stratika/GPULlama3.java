...
public class Qwen3TornadoWeights extends TornadoWeights {
    ...
    public Qwen3TornadoWeights(FloatArray tokenEmbeddingTable, FloatArray[] rms_att_weightLayered,
            ...
            FloatArray[] rms_att_KNormLayered, FloatArray[] rms_att_QNormLayered,
            FloatArray[] rms_ffn_weightLayered,
            HalfFloatArray[] w1Layered, HalfFloatArray[] w2Layered, HalfFloatArray[] w3Layered,
        ...
        super(tokenEmbeddingTable, rms_att_weightLayered,
                ...
                w1Layered, w2Layered, w3Layered, rms_final_weight_as_floatArray,
